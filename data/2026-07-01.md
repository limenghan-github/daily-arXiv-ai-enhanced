...
### [18] [Morpho-kinematic of galaxies at cosmic noon](https://arxiv.org/abs/2606.30710)
...
### [19] [Little Red Dots as Intermediate Mass, Super-Eddington Engines: Insights from Type IIn Supernovae and The 1837-1856 Great Eruption of $η$ Carinae](https://arxiv.org/abs/2606.30711)
...
### [20] [Hunting Wandering 3<z<8 Black Holes: via Spatial Offsets in Ionization Ratio and Continuum Emission](https://arxiv.org/abs/2606.30715)
...
### [21] [Tidal origin of dark-matter free dwarf galaxies in the NGC 1052 group](https://arxiv.org/abs/2606.30718)
...
### [22] [Global trends in morphology from massive to dwarf galaxies](https://arxiv.org/abs/2606.30719)
...
### [23] [AGN-driven outflows in dwarf galaxies from cosmological simulations: Internal properties and observational signatures](https://arxiv.org/abs/2606.30726)
...
### [24] [A new era for Dual AGN science with SHARP](https://arxiv.org/abs/2606.30727)
...
### [25] [The Lifetimes of High-redshift Quasars Suggest Magnetic Disk Support](https://arxiv.org/abs/2606.30734)
...
### [26] [Gravitational-Electric Polarization as a Probe of Dark Matter and Modified Gravity](https://arxiv.org/abs/2606.30736)
*Nirupam Roy*
...
### [27] [ALMA visits the QSO MUSEUM: connecting molecular gas and the cool circumgalactic medium around 37 z~3 quasars](https://arxiv.org/abs/2606.30742)
...
### [28] [Introducing AuriGLOBES: the effect of compressive tides, compact object-induced mass loss, and size evolution on modelling globular clusters](https://arxiv.org/abs/2606.30746)
...
### [29] [A Pixel-by-Pixel Path to Population III Discovery with JWST](https://arxiv.org/abs/2606.30750)
...
### [30] [Wrinkles in Time. II. Stellar Age Trends in Kinematic Signatures from Transient Spiral Structure](https://arxiv.org/abs/2606.30752)
...
### [31] [Unveil the nature of JWST-AGN and Little Red Dots with SKAO continuum surveys](https://arxiv.org/abs/2606.30757)
...
### [32] [A SHARP Look at Quenching and Bulge-Disk Growth in Massive Galaxies at Cosmic Noon](https://arxiv.org/abs/2606.30763)
...
### [33] [JWST spectroscopy of galaxies at $z>10$: Damped Ly$α$ absorbers reveal efficient star formation and hidden redshift biases](https://arxiv.org/abs/2606.30787)
...
### [34] [A Census of the 200 Most Massive Galaxies Spectroscopically Observed with JWST at zspec $\sim$3-15](https://arxiv.org/abs/2606.30802)
...
### [35] [Time-dependent adaptive mesh refinement solver for the Gross-Pitaevskii-Poisson equations](https://arxiv.org/abs/2606.30827)
*Iván Álvarez-Rios*
...
### [36] [SMGPS: A study of Galactic HII regions with extended morphology](https://arxiv.org/abs/2606.30832)
...
### [37] [SUNRISE-3D: Sharp UNveiling of AGN feedback Regulation and its Impact on Star-formation at the cosmic noon Epoch](https://arxiv.org/abs/2606.30833)
...
### [38] [An Acceleration is Worth a Hundred Thousand Phase Space Measurements](https://arxiv.org/abs/2606.31042)
...
### [39] [Deep Extragalactic VIsible Legacy Survey (DEVILS): Morphologically-selected galaxy merger fractions and their direct comparison to close-pair samples](https://arxiv.org/abs/2606.31140)
...
### [40] [Chemical evolution of the Milky Way disc with radial gas flows: a Lagrangian approach](https://arxiv.org/abs/2606.31161)
*Fiorenzo Vincenzo*
...
### [41] [Probing IMF Variations in High-Redshift Early-Type Galaxies with SHARP](https://arxiv.org/abs/2606.31189)
...
### [42] [The Sc, Ti, and V Abundance Discrepancy: Testing High-Mass IMF Variation and Massive-Star Rotation](https://arxiv.org/abs/2606.31218)
...
### [43] [Cosmic Rulers: Masers as Tools for Probing Structure in the Galaxy and Beyond, from AU to kpc](https://arxiv.org/abs/2606.31237)
...
### [44] [Dissecting the Obscured Core of GN20: an Active Galactic Nucleus Outshone by Young Stars](https://arxiv.org/abs/2606.31312)
...
### [45] [GSED: The Galactic Stellar Extinction Database](https://arxiv.org/abs/2606.31374)
...
### [46] [Boosting Water Maser Studies in AGN with the SKA](https://arxiv.org/abs/2606.31401)
...
### [47] [Unveiling the properties of galaxy cores excavated by supermassive black hole binaries with SHARP](https://arxiv.org/abs/2606.31434)
...
### [48] [A simulation-based analytic model of radio galaxies II: self-consistent radiative losses](https://arxiv.org/abs/2606.31486)
*M. J. Hardcastle*
...
### [49] [Interstellar filament detection and characterization: methods and implications for studies of magnetized interstellar medium](https://arxiv.org/abs/2606.31507)
*Dana Alina*
...
### [50] [The metallicities of little red dot host galaxies: LRDs are metal poor, but not pristine](https://arxiv.org/abs/2606.31515)
...
### [51] [A generalized linear matrix method for normal modes in collisionless stellar disks](https://arxiv.org/abs/2606.31523)
...
### [52] [The FAST All Sky HI Survey DR2: the FASHI Catalog and the HI Mass Function](https://arxiv.org/abs/2606.31539)
...
### [53] [Tracing Cold Gas in Absorption Across Cosmic Time with the SKA](https://arxiv.org/abs/2606.31546)
...
### [54] [Electron Densities of Typical Low-Mass Galaxies at z~2-7 from Stacked JWST/NIRSpec Spectra](https://arxiv.org/abs/2606.31549)
*Shihong Liu,Yu Rong*
...
### [55] [Physical and Chemical Conditions of Molecular Gas in NGC 1068: The nuclear feedback in the circumnuclear disk and starburst ring](https://arxiv.org/abs/2606.31611)
...
### [56] [A big step forward with SHARP: spatially resolved stellar population properties in passive galaxies at z > 1.5](https://arxiv.org/abs/2606.31628)
...
### [57] [Possible chemical signatures of first-star enrichment in a very metal-poor galaxy overdensity near the end of reionization](https://arxiv.org/abs/2606.31638)
...
### [58] [Fueling and feedback mechanisms at the nodes of the cosmic web](https://arxiv.org/abs/2606.31671)
...
### [59] [AGN Feedback: The impact of galactic-scale radio jets on the interstellar medium in starbursting obscured AGN](https://arxiv.org/abs/2606.31673)
...
### [60] [Chemo-dynamical Analysis of Eight UBC Open Clusters](https://arxiv.org/abs/2606.31714)
...
### [61] [Uncovering neutral Hydrogen clouds in Radio Galaxies in the SKA era](https://arxiv.org/abs/2606.31773)
...
### [62] [Distance to Sh2-106 from Gaia DR3 and its embedded radio population: implications for a candidate explosive outflow](https://arxiv.org/abs/2606.31835)
*Sergio A. Dzib*
...
### [63] [AGN Feeding & Feedback Over the Galactic Scales](https://arxiv.org/abs/2606.31847)
...
### [64] [Unveiling the Cosmic Dawn with SHARP: Probing extended Lyman-$α$ nebulae in a Universe less than 600 Myr old](https://arxiv.org/abs/2606.31917)
...
### [65] [Caught in the act: interaction-driven evolution in the nearby compact galaxy group Roberts Quartet (SCG0018-4854)](https://arxiv.org/abs/2606.31960)
...
### [66] [COSMOS-Web: does halo mass alone shape the clustering of star-forming and quiescent galaxies?](https://arxiv.org/abs/2606.31978)
