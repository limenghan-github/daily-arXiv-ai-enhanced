...
### [29] [Cosmic CORALS: Timing the Universe with high-z star clusters](https://arxiv.org/abs/2607.19472)
...
### [30] [The silent dark sector: a field-theory approach to unified dark fluids with vanishing speed of sound](https://arxiv.org/abs/2607.19494)
...
### [31] [Probing the matter-dominated expansion with multi-redshift Lyman-$α$ BAO from DESI DR2](https://arxiv.org/abs/2607.19619)
...
### [32] [Dynamical Test of Cosmic Acceleration: $k$-nearest Neighbor Cross Correlation of Cosmic Microwave Background and Cosmic Infrared Background](https://arxiv.org/abs/2607.19648)
...
### [33] [Constraining Effective Viscosity in the Intracluster Medium via the Thermal Sunyaev-Zeldovich Effect -- Predictions from the SLOW Constrained Coma Cluster Simulations](https://arxiv.org/abs/2607.19753)
...
### [34] [Accurate parameter inference for the Light-cone Epoch of Reionization 21-cm signal](https://arxiv.org/abs/2607.19792)
...
### [35] [QCD CP-violation scenario for a revised cosmological dynamics: analysis of the binned Pantheon Sample of Super Novae Ia](https://arxiv.org/abs/2607.19915)
...
### [36] [Ringing of the Reionization: A first direct measurement of the intergalactic pressure smoothing scale at redshift z>4.2 as imprinted onto small-scale peculiar velocities in the Lyman-alpha forest](https://arxiv.org/abs/2607.19938)
...
### [37] [Modeling the HI-Halo Connection: Evolution, Scatter, and a Halo-based Prescription for 21-cm Mock Catalogs](https://arxiv.org/abs/2607.20123)
...
### [38] [Can cosmic voids ease the Hubble tension? Local expansion in $w_0w_a$CDM](https://arxiv.org/abs/2607.20257)
...
### [39] [Interacting Dark Energy and Dark Matter in O(3) No-Scale Gravity](https://arxiv.org/abs/2607.20320)
...
### [40] [Beyond $j=1$: Observational Constraints on Almost-$Λ$CDM Cosmologies](https://arxiv.org/abs/2607.20348)
...
### [41] [The burgeoning rise of the 21-cm forest I: constraints on the optical depth of the intergalactic medium at $5.38 < z < 5.84$](https://arxiv.org/abs/2607.20371)
...
### [42] [The road towards precision measurements of $H_0$ with bright sirens in the Einstein Telescope era](https://arxiv.org/abs/2607.20413)
...
### [43] [Primordial black holes forming during kination: the trapped, the overdense, and the void](https://arxiv.org/abs/2607.20423)
*Cristian Joana*
